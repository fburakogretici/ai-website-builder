        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                {locale === 'tr' 
                  ? 'AI destekli web sitesi oluşturucu ile profesyonel siteler dakikalar içinde.'
                  : 'Professional websites in minutes with AI-powered website builder.'
                }
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#templates" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                    {locale === 'tr' ? 'Temalar' : 'Templates'}
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            <p className="text-center text-gray-500 dark:text-gray-400">
              © {new Date().getFullYear()} NoCodePage - {locale === 'tr' ? 'Tüm hakları saklıdır' : 'All rights reserved'}.
            </p>
          </div>
        </div>
      </footer>
