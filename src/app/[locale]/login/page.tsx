      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-md w-full">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            {/* Tab Buttons */}
            <div className="flex items-center gap-2 mb-5 bg-gray-100 dark:bg-gray-700/50 rounded-xl p-1.5">
              <button
                onClick={() => {
                  setIsLogin(true);
                  setAuthError(null);
            ...
            <form onSubmit={isLogin ? handleLogin : handleSignup} className="space-y-4" noValidate>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200"
                  value={email}
                  onChange={(e) => {
              ...
              <button
                type="submit"
                className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold text-base hover:shadow-2xl hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 flex items-center justify-center group"
              >
          ...
          <div className="mt-6 grid grid-cols-3 gap-3 text-center">
            <div>
              <div className="text-xl font-bold text-indigo-600 dark:text-indigo-400">100+</div>
              <div className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">{locale === 'tr' ? 'AI Şablonlar' : 'AI Templates'}</div>
            </div>
            <div>
              <div className="text-xl font-bold text-purple-600 dark:text-purple-400">5 {locale === 'tr' ? 'Dk' : 'Min'}</div>
              <div className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">{locale === 'tr' ? 'Hızlı Kurulum' : 'Quick Setup'}</div>
            </div>
            <div>
              <div className="text-xl font-bold text-pink-600 dark:text-pink-400">24/7</div>
