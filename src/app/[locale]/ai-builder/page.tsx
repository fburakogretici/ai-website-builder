...
export default function AIBuilderPage() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden flex flex-col">
      {/* Premium Header */}
      <div className="bg-gradient-to-r from-slate-800/80 via-slate-800/60 to-slate-800/80 backdrop-blur-xl border-b border-white/5 px-8 py-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="group p-2 text-slate-400 hover:text-white rounded-xl hover:bg-white/5 transition-all duration-300"
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <div className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-gradient-to-r from-emerald-400 to-green-500 rounded-full border-2 border-slate-800 animate-pulse"></div>
                </div>
                <div>
            ...
            {generatedHtml && (
              <div className="flex items-center gap-3">
                ...
                {/* Undo/Redo */}
                <div className="flex items-center gap-1 bg-slate-700/30 rounded-lg p-1 ring-1 ring-white/5">
                  <button
                    onClick={handleUndo}
                    disabled={historyIndex <= 0}
                    className="p-1.5 hover:bg-slate-600/50 text-slate-400 hover:text-white rounded-md transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                    title="Undo"
                  >
                ...
                <div className="relative">
                  <input
                    ...
                    className="px-3 py-2 bg-slate-700/40 border border-slate-600/50 rounded-lg text-white placeholder:text-slate-500 focus:outline-none focus:border-purple-400/50 focus:ring-1 focus:ring-purple-400/20 text-sm w-40 transition-all"
                  />
                </div>
                ...
                {websiteId && (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                      websiteStatus === 'published'
                        ? 'bg-slate-600/80 hover:bg-slate-600 text-slate-200 ring-1 ring-slate-500/50'
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full max-w-[1800px] mx-auto px-8 py-6 grid grid-cols-2 gap-6">
          {/* Left Panel - Chat */}
          <div className="flex flex-col bg-slate-800/30 backdrop-blur-sm rounded-2xl border border-white/5 overflow-hidden ring-1 ring-white/5">
            {/* Messages */}
            <div
          ...
          <div className="p-3 border-t border-slate-700/50">
            <div className="flex gap-2">
              <textarea
                ...
                className="flex-1 bg-slate-700/50 text-white placeholder-slate-400 rounded-lg px-3 py-2.5 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                rows={2}
          ...
          {generatedHtml ? (
            <>
              <div className="flex-shrink-0 px-3 py-2 bg-slate-800/50 border-b border-slate-700/50 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-2 py-1 text-xs bg-slate-700/50 hover:bg-slate-700 text-slate-300 rounded transition-all flex items-center gap-1"
                >
            ...
            <div className="flex-1 flex items-center justify-center p-6">
              <div className="text-center text-slate-400 space-y-4 max-w-sm">
