...
export default function SettingsLayout({
  ...
  const menuItems = [
    ...
    {
      name: t('settings.menu.notifications'),
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-200/50 dark:border-gray-700/50 overflow-hidden sticky top-24">
              <div className="p-4 border-b border-gray-200/50 dark:border-gray-700/50">
                <h2 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wide">{t('settings.title')}</h2>
              </div>
              <nav className="p-2">
                {menuItems.map((item) => {
