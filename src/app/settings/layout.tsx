...
export default function SettingsLayout({
  ...
  const menuItems = [
    ...
    {
      name: locale === 'tr' ? "Güvenlik" : "Security",
    ...
    {
      name: locale === 'tr' ? "API Anahtarları" : "API Keys",
    ...
    {
      name: locale === 'tr' ? "Bildirimler" : "Notifications",
