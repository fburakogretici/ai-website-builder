        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-4 -mt-4">
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-white">{locale === 'tr' ? 'Bültene Abone Ol' : 'Subscribe to Newsletter'}</h4>
              <div className="flex gap-2">
                <input 
                  type="email" 
                  placeholder={locale === 'tr' ? 'E-posta adresiniz' : 'Your email'}
                  className="flex-1 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-transparent transition-all"
                />
          ...
          <div className="lg:col-span-2">
            <h3 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">{locale === 'tr' ? 'Ürün' : 'Product'}</h3>
          ...
          {/* Company Links */}
          <div className="lg:col-span-2">
            <h3 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">{locale === 'tr' ? 'Şirket' : 'Company'}</h3>
            <ul className="space-y-3">
              <li>
          ...
          {/* Support Links */}
          <div className="lg:col-span-2">
            <h3 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">{locale === 'tr' ? 'Destek' : 'Support'}</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm flex items-center group">
          ...
          {/* Legal Links */}
          <div className="lg:col-span-2">
            <h3 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">{locale === 'tr' ? 'Yasal' : 'Legal'}</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm flex items-center group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-indigo-500 mr-0 group-hover:mr-2 transition-all duration-200"></span>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-indigo-600 hover:border-indigo-600 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:shadow-indigo-500/25"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-purple-600 hover:border-purple-600 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:shadow-purple-500/25"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-pink-600 hover:border-pink-600 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:shadow-pink-500/25"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
